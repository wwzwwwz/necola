...
public class SoundService2 extends Service implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnBufferingUpdateListener {

    private final static String FOREGROUND_CHANNEL_ID = "foreground_channel_id";
    private final static String TAG = SoundService2.class.getSimpleName();
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(SoundService2.class.getSimpleName(), "onCreate()");
    ...
    private Notification prepareNotification() {
        ...
        Intent lPauseIntent = new Intent(this, SoundService2.class);
        ...
        Intent playIntent = new Intent(this, SoundService2.class);
        ...
        Intent lStopIntent = new Intent(this, SoundService2.class);
        ...
        if (lWifi != null && lWifi.isConnected()) {
            ...
            if (manager != null) {
                mWiFiLock = manager.createWifiLock(
                        WifiManager.WIFI_MODE_FULL, SoundService2.class.getSimpleName());
                mWiFiLock.acquire();
            }
